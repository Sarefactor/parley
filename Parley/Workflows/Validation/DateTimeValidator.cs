...
public static class DateTimeValidator
{
    public static bool Validate(string input, ValidationRule rule)
        => DateTime.TryParse(input, CultureInfo.InvariantCulture, DateTimeStyles.None, out var value)
           && ComparisonEvaluator.Evaluate(value, rule.MatchDateTime, rule.NumberComparisonType);
